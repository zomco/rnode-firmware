...
void measure_battery() {
  #if BOARD_MODEL == BOARD_RNODE_NG_21 || BOARD_MODEL == BOARD_LORA32_V2_1 || BOARD_MODEL == BOARD_HELTEC32_V3 || BOARD_MODEL == BOARD_HELTEC32_V4 || BOARD_MODEL == BOARD_TDECK || BOARD_MODEL == BOARD_T3S3 || BOARD_MODEL == BOARD_EORA_S3 || BOARD_MODEL == BOARD_HELTEC_T114 || BOARD_MODEL == BOARD_TECHO || BOARD_MODEL == BOARD_FAKETEC || BOARD_MODEL == BOARD_XIAOWA
    ...
    #elif BOARD_MODEL == BOARD_EORA_S3
      float battery_measurement = (float)(analogRead(pin_vbat)) / 4095.0*6.96;
    #elif BOARD_MODEL == BOARD_HELTEC_T114
      float battery_measurement = (float)(analogRead(pin_vbat)) * 0.017165;
    #elif BOARD_MODEL == BOARD_TECHO
      float battery_measurement = (float)(analogRead(pin_vbat)) * 0.007067;
    #elif BOARD_MODEL == BOARD_FAKETEC || BOARD_MODEL == BOARD_XIAOWA
      float battery_measurement = (float)(analogRead(pin_vbat)) * 0.007038;
    #else
...
bool init_pmu() {
  ...
  #if BOARD_MODEL == BOARD_RNODE_NG_21 || BOARD_MODEL == BOARD_LORA32_V2_1 || BOARD_MODEL == BOARD_TDECK || BOARD_MODEL == BOARD_T3S3 || BOARD_MODEL == BOARD_EORA_S3 || BOARD_MODEL == BOARD_TECHO || BOARD_MODEL == BOARD_FAKETEC || BOARD_MODEL == BOARD_XIAOWA
